...
@section('content')
    <section>
        <div class="section-body">
            ...
            {{ Form::open(['route' =>'whychooseus.store','class'=>'form form-validate','role'=>'form', 'files'=>true, 'novalidate']) }}
            @include('backend.whychooseus.partials.form', ['header' => 'Create a whychooseus'])
            {{ Form::close() }}
        </div>
    </section>
@stop
